<template>
  <div class="home" @click="menuVisible = false">
    <form class="search-form">
      ...
      <!-- 第二层选择 -->
      <div class="form-line" :id="'form-line' + i" v-for="(seg, i) in segments">
        <div class="segIndex">
          <span>第 {{ i + 1 }} 段</span>
        </div>
        <!-- 起始地选择 -->
        <div class="flt-box">
          ...
          <div class="flt-depart">
            ...
            <div class="select-box">
              <el-select v-model="seg.depart" filterable placeholder="出发地">
                <el-option
          ...
          <div class="flt-arrival">
            <span>目的地</span>
            <div class="select-box">
              <el-select v-model="seg.arrival" filterable placeholder="出发地">
                <el-option
                  v-for="item in options"
                  :key="item.value"
                  :label="item.label"
